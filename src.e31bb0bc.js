...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"brainfuckInterpreter.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MachineState = exports.default = void 0;
...
function () {
  ...
  _createClass(Interpreter, [{
    ...
    value: function _step() {
      ...
      var instruction = this.source[this.ins_pointer];
    ...
    key: "_putchar",
    value: function _putchar() {
      console.log(String.fromCharCode(this.value));
    }
  }, {
    key: "_getchar",
    value: function _getchar() {}
  }, {
    key: "_start_loop",
    value: function _start_loop(ins_index) {
      var ins_pointer = this.ins_pointer;
      var val = this.value;
    ...
    key: "_end_loop",
    value: function _end_loop() {
      var mem_pointer = this.mem_pointer;
      var val = this.value;

      if (val != 0) {
        var jump_target = this.stack.pop();
    ...
    key: "_seek_loop_end",
    value: function _seek_loop_end() {
      var _this2 = this;

      var ins_pointer = -this.source.split("").map(function (v, i, l) {
        if (i < _this2.state.ins_pointer) {
          return null;
        } else {
          if (v === "[") return +1;else if (v === "]") return -1;else return null;
        }
      }).reduce(function (acc, cur, i, l) {
        if (acc < 0) return acc;else if (acc === null && cur) return cur;else if (acc && cur) return acc + cur;else if (acc === 0) return -i;else return acc;
      }, null);
    ...
    set: function set(val) {
      ...
      var next = this._posmod(val, length);
    ...
    set: function set(val) {
      ...
      var new_val = this._posmod(val, size);
    ...
    key: "state",
    get: function get() {
      return new MachineState(this.memory, this.ins_pointer, this.mem_pointer);
    }
  }], [{
    key: "validate",
    value: function validate(program) {
      var regex = /\[\]/gm;
      var opened = 0;
...
var MachineState = function MachineState(memory, ins_pointer, mem_pointer) {
...
var _brainfuckInterpreter = _interopRequireDefault(require("./brainfuckInterpreter"));
...
function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement(Machine, null);
    }
  }]);
...
function (_Component2) {
  ...
  function Machine(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Machine).call(this, props));
    _this.interpreter = new _brainfuckInterpreter.default(300);
    var machine_state = _this.interpreter.state;
    _this.state = {
      source: "",
      length: 10,
      speed: 300,
  ...
  _createClass(Machine, [{
    key: "updateMachineState",
    value: function updateMachineState() {
      var machine_state = this.interpreter.state;
      this.setState({
        memory: machine_state.memory,
        ins_pointer: machine_state.ins_pointer,
        mem_pointer: machine_state.mem_pointer
    ...
    value: function random() {
      ...
      var source = this.constructor._generateRandom(this.state.length);

      this.setState({
        source: source
      }, function () {
        _this4.interpreter.source = source;
    ...
    value: function run() {
      ...
      var cutoff = 300;
      var interval = Math.max(cutoff - speed, 10);
      var steps = Math.max(speed - cutoff, 1);
    ...
    key: "_runSteps",
    value: function _runSteps(number) {
    ...
    key: "step",
    value: function step() {
      var new_state = this.interpreter.step();
      this.setState({
        locked: true,
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        onChange: function onChange(event) {
          return _this6._setLength(event);
        }
      }), _react.default.createElement(Slider, {
        id: "speed",
        min: "1",
        ...
        onChange: function onChange(event) {
          return _this6._setSpeed(event);
        }
      }), _react.default.createElement("button", {
        onClick: function onClick() {
          return _this6.random();
        }
      }, "\uD83D\uDD00"), _react.default.createElement("button", {
        onClick: function onClick() {
          return _this6.stop();
    ...
    key: "_generateRandomCharacter",
    value: function _generateRandomCharacter() {
      var index = Math.floor(bfInstructions.length * Math.random());
      return bfInstructions[index];
    }
  }, {
    key: "_generateRandom",
    value: function _generateRandom(length) {
      var source = "";
      ...
      while (true) {
        ...
        if (_brainfuckInterpreter.default.validate(source)) {
          return source;
        } else {
          source = "";
        }
...
function (_Component3) {
  ...
  function Slider(props) {
    ...
    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(Slider).call(this, props));
    _this7.state = {
      value: 10
    };
    return _this7;
...
function (_Component4) {
  _inherits(InputBox, _Component4);
...
function (_Component5) {
  _inherits(SourceBox, _Component5);

  function SourceBox() {
    _classCallCheck(this, SourceBox);

    return _possibleConstructorReturn(this, _getPrototypeOf(SourceBox).apply(this, arguments));
  }

  _createClass(SourceBox, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "sourceBox"
...
function (_Component6) {
  _inherits(Bitmap, _Component6);

  function Bitmap() {
    _classCallCheck(this, Bitmap);

    return _possibleConstructorReturn(this, _getPrototypeOf(Bitmap).apply(this, arguments));
  }

  _createClass(Bitmap, [{
    key: "render",
    value: function render() {
      var mem = this.props.memory; // var pixels = Array(Math.floor(mem.length / 3))

      var pixels = mem.map(function (v, i, l) {
        return i % 3 == 0 ? _react.default.createElement(Pixel, {
          key: i,
          r: v,
          g: l[i + 1],
          b: l[i + 2]
...
function (_Component7) {
  _inherits(Pixel, _Component7);

  function Pixel() {
    _classCallCheck(this, Pixel);

    return _possibleConstructorReturn(this, _getPrototypeOf(Pixel).apply(this, arguments));
  }
...
},{"react":"../node_modules/react/index.js","./brainfuckInterpreter":"brainfuckInterpreter.js"}],"index.js":[function(require,module,exports) {
"use strict";
